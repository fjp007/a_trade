...
class XLSXFileManager:
    def __init__(self, file_path, sheet_name, header, unique_indices, force_delete=False):
        """
    ...
    def insert_and_save_data_list(self, data_list):
        """
